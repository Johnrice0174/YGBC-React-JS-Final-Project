...
class SignupChat extends React.Component {
  ...
  render(){
    ...
    return(
      <main className={classes.main}>
        <Helmet><title>YGBC- Chat Signup</title></Helmet>
        ...
        <Paper className={classes.paper}>
          ...
          <Link className={classes.logInLink} to='/chatlogin'>Log In!</Link>
        </Paper>
      </main>
    );
  }
    ...
    firebase
      ...
      .then(authRes => {
        ...
        firebase
          ...
          .set(userObj)
          .then(() => {
            this.props.history.push('/chatdashboard');
        }, dbErr => {
...
export default withStyles(styles)(SignupChat);
